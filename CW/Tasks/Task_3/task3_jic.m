...
circular_movement(pose_4, x_4, y_4, z_4, close, 25 + 3, -180, 90, port_num); % change circle angles

move_cube_task_2(pose_4, 175 + X_offset, 200 + Y_offset, 130, close, 10, port_num);
