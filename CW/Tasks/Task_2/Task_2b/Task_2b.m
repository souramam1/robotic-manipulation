...
[end_pose1_hov,end_x1_hov,end_y1_hov,end_z1_hov,end_grip_1_hov] = hover_above_back(end_p1,end_x1,end_y1,end_z1,end_g1); 
%-------fill arrays
for i = 1:3
...
for i = 1:8
Move_Cube(Cpose_1(i), Cx_1(i), Cy_1(i), Cz_1(i), Cgripper_1(i));
end
